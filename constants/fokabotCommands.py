...
def changeLocation(fro, chan, message):
	...
	if theUser is not None:
		...
		if bool(permissions & privileges.USER_DONOR):
			...
			return "Bad luck, you're not a donatior, therefore you can't do that."
...
def editMap(fro, chan, message): # Edit maps ranking status ingame. // Added by cmyui :)
	...
	webhookHelper.postWebhook(glob.conf.extra["ranked-webhook"], args={
		...
		"footer_icon": "https://assets.ppy.sh/beatmaps/" + str(beatmapData["beatmapset_id"]) + "/covers/cover.jpg",
		"author": name,
