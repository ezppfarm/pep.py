...
class handler(requestsManager.asyncRequestHandler):
	...
	@tornado.gen.engine
	def asyncGet(self):
		html = 	"<html><head><title>Yozora Bancho Server</title><style type='text/css'>body{width:30%}</style></head><body><pre>"
		html += "___  __<br>"
		html += "_\ \/ /_______________________________<br>"
		html += "__/ /_  __ \__  /_  __ \_  ___/  __ `/<br>"
		html += " / / / /_/ /_  /_/ /_/ /  /   / /_/ /<br>"
		html += "/_/  \____/_____/\____//_/    \__,_/<br>"
		html += "<b>Yozora Bancho Server, (c) Yozora</b><br>"
		html += "<br><br>come join us for a game: https://yozora.pw<br>server status: https://info.yozora.pw<br><br><i>jackson crashed the boat.</i></pre></body></html>"
		self.write(html)